...
```{r, echo=FALSE, fig.cap="Step 3. Create RStudio project from version control."}
...
```{r,echo=FALSE, fig.cap="Step 4. Create a project from a Git repository."}
knitr::include_graphics("img/clone-git.png")
```


```{r, echo=FALSE, fig.cap="Step 4. Clone Git repository and create project."}
...
```{r, echo=FALSE, fig.cap="Step 5. Empty project. Note missing README. "}
